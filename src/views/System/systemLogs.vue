        ...
        <div class="bgWhite-public">
            ...
            <div class="bgWhite-padd20">
                ...
                <el-table class="pub-table edit-table" :data="logTable" border>
                    ...
                    <el-table-column prop="log_content" label="log_content"></el-table-column>
                    <el-table-column prop="log_type" label="log_type"></el-table-column>
...
<script>
    import {getLogListApi, } from "@/assets/js/api";
    import navRefush from '@/components/navRefush/navRefush' /*按钮组件  */
    export default {
        name: "systemLogs",  //日志管理
        data() {
            return {
                btnLoad: {
                    btnBack:false,
        ...
        methods: {
            ...
            PageCurrent(page) {
                console.log(page);
                this.logParm.page = page;
                this.FnGetLogList();
            },
            PageSizeChange(val){
                console.log(val);
                this.logParm.paginate = val;
                this.FnGetLogList();
            },
